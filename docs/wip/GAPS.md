...
Owed (the rest of Phase 6): hard links, symlinks and metadata (mode, xattrs) in the deriver, a file/directory transition at one path, and the rare reused-base-path rename combination above; the checkpoint folding above; the green
