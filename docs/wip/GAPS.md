...
this host); and the merge and namespace async verbs (the same three-line typed shape). The Rust
client parks on the word and needs none. The Windows named Event per client (Phase
