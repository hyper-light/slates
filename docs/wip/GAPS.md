...
Owed (the rest of Phase 6): directories, hard links, symlinks and metadata (mode, xattrs) in the deriver, and the rare reused-base-path rename combination above; the checkpoint folding above; the splice by extent surgery, the green
