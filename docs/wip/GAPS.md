...
Owed (the rest of Phase 6): hard links, symlinks and xattrs in the deriver, a file/directory transition at one path, chmod then rename, and the rare reused-base-path rename combination above; the checkpoint folding above; the green
