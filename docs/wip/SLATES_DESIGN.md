...
> host. Hard links, symlinks and metadata in the deriver, the checkpoint folding of the
> canonical deltas, the green chain and the fenced ledger register, and holder recomputation are
> the rest of Phase 6.
