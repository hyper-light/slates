...
> deriver (a journal of content, create, unlink and rename composed into one ops document —
...
> host. Directories, links, symlinks and metadata in the deriver, the checkpoint folding of the
