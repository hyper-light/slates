...
> whole-filesystem reconstruction oracle). All on every host. Directories, links, symlinks and
> metadata in the deriver, the checkpoint folding of the canonical deltas, the splice by extent
> surgery, the green chain and the fenced ledger register, and holder recomputation are the rest
> of Phase 6.
