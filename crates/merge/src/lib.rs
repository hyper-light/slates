...
//! randomness, or (in its hot comparison) allocates; the position mapping, the splice, the
//! chain and the fleet commit are the engine's other pieces, built on this.
//!
