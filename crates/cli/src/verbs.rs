...
use slates_client::{
  AuditEntry, Client, ClientError, CreateSpec, DaemonReport, Deadlines, Digest, GrantSummary,
...
#[cfg(test)]
mod tests {
  use super::{digest_json, signal_value};
  use slates_client::{AbsenceIs, Digest, Signal};
